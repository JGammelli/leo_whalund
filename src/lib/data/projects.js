...
export const projects = [
  ...
  },
  {
    ...
    programText: "Some Program text here",
    link: "The very early stages of a 2d platformer I am working on together with one other person where I am doing the design and programming. The objective as of now is to make a solid proof of concept, something that starts with making the movement and attacks crisp, providing agency to the player.",
  },
];
