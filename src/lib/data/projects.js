...
export const projects = [
  {
    title: `Vanagandar`,
    content: `An online tactical shooter akin to CS and Valorant. A side project I worked on part time while having courses.
  ...
  {
    title: `Tomb of Alar`,
    content: `Having betrayed its allies, a wraith now seeks to escape the tomb with its newfound immortality.
    ...
    isDesign: true,
    isProgram: false,
    designText: `Note: I will not be writing detailed information code implementation here. This will be more about the code structure and how we worked as a team.
    ...
    link: "https://felltree-interactive.itch.io/methuselah",
  },
  {
    title: `Methusela`,
    content: `Methuselah is a topdown roguelike where the player fights as the force of the forest against the machines that want to tear it down.`,
  ...
  {
    title: `Zhi`,
    content: `Follow a girl and her dog as they explore an old apartment and learn of its past.`,
    image: ``,
    isDesign: true,
    isProgram: false,
    designText: ``,
  ...
  },
  {
    ...
    content: `Bring a friend and find the city's hazardous treasures! 
  ...
  {
    title: `Misty Woods`,
    content: `Explore a misty forest as you solve puzzles and escape the island.`,
    image: ``,
    isDesign: true,
    isProgram: false,
    designText: ``,
  ...
  },
  {
    ...
    link: "https://drive.google.com/file/d/1t1PiOq7WooLDD2WEnwM4h8R93yx3gA-l/view?usp=sharing",
  },
  {
    title: `Bouncing Ball`,
    content: `A unique game where you control a bouncing ball and platforms as you navigate through 6 very different levels.`,
    ...
    programText: "Some Program text here",
    link: "https://drive.google.com/file/d/1eveHOMsnAGDD3V2LAl2RvD9iPa0ja_yk/view?usp=sharing",
  },
  {
    title: `Behemoth Battles`,
    content: `An attempt at bringing over a board game (created by myself) to the digital world in order to create and explore more transformative mechanics.`,
  ...
  },
  {
    ...
    content: `A mobile game created to explore the effect that synergies can have on player experience and overall enjoyment.`,
  ...
  {
    title: `Slice Dude`,
    content: `A game-jam game about a dude slicing things. When your only tool is a hammer, every problem becomes a nail. Well, when your arms are swords, every problem becomes slice-able.`,
    ...
    programText: "Some Program text here",
    link: "https://drive.google.com/file/d/1KOZSj7uhzDVGTy9OnfuXgvdAcKJzuIGB/view?usp=sharing",
  },
];
